  ...
  return {
    ...
    link: function(scope, element, attrs, form) {
      ...
      scope.canSave = function() {
        return !form.$pristine && !angular.equals(resource, original) && form.$valid;
      };
      ...
      scope.getCssClasses = function(fieldName) {
        ...
        return {
          'has-error': ngModelController.$invalid && ngModelController.$dirty && !angular.equals(resource, original),
          'has-success': ngModelController.$valid && !angular.equals(resource, original)
        };
      };
