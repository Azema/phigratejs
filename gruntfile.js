...
module.exports = function(grunt) {
  ...
  grunt.initConfig({
    ...
    watch: {
      js: {
        files: ['gruntfile.js', 'server.js', 'server/**/*.js', '!public/vendor/*.js', 'public/**/*.js', 'test/**/*.js'],
        tasks: ['jshint'],
        options: {
          livereload: true
        }
      ...
      html: {
        files: ['public/**/views/*.html', 'server/views/**'],
        options: {
          livereload: true
        }
      },
    ...
    jshint: {
      all: {
        src: ['gruntfile.js', 'server.js', 'server/**/*.js', '!public/vendor/*.js', 'public/**/*.js', 'test/**/*.js', '!test/coverage/**/*.js'],
        options: {
          jshintrc: true
        }
      }
